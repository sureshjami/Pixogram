                    ...
                    <div class="secondary-shadow bg-dark p-4" style=" box-shadow: 0 20px 25px -18px rgba(3, 142, 255, 0.781);">
                         ...
                         <form method="post" action="uploadMedia" enctype="multipart/form-data" class="pt-4">                     
                             ...
                             <div class="card-text d-flex">                           	          		                                				 
                                   <input type="file" accept=".mp4,.jpg,.png,.jpeg,.gif,.wmv,.avi|audio/*|video/*|image/*|media_type" class="btn btn-light m-1 form-control" style="background-color:gray;" id="media" name="media" size="50" />    
