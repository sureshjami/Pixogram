        ...
        <div class="row m-4">
                    ...
                    <div class="card border-info  mb-3">
                        ...
                        <div class="card-body">
                            <p class="card-text d-flex flex-column">
                                <a href="news" class="btn btn-dark m-1 form-control">Newsfeed</a>
            ...
            <div class="col-lg-8 mt-2">
                <div class="secondary-shadow bg-dark p-4" style="box-shadow: 0 20px 25px -18px rgba(3, 142, 255, 0.781);">
                    <h5 class="h2" style="color:aliceblue">Account Update</h5>
                    <form action="#" class="pt-4">
                        <div class="form-group row">
                            <label for="username" class="col-3 col-form-label" style="color:aliceblue">User Name</label>
                            <div class="col-6">
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-3 col-form-label" style="color:aliceblue">Password</label>
                            <div class="col-8">
                                <input type="text" class="form-control" name="password" id="password">
                            </div>
                        </div>
                        <div class="form-group row align-items-center">
                            <label for="rPassword" class="col-4 col-form-label" style="color:aliceblue">Repeat Password</label>
                            <div class="col-8">
                                <input type="text" class="form-control" name="rPassword" id="rPassword" style="">
                            </div>
                        </div>
                        <div class="form-group row align-items-center">
                            <label for="email" class="col-3 col-form-label" style="color:aliceblue">Email</label>
                            <div class="col-8">
